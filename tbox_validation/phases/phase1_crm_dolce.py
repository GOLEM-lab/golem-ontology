...
PHASE1_STACK = [
    ...
    # LRMoo internally imports this exact versionIRI; must be explicitly
    # requested so build_world() resolves it locally (per core/loader.py's
    # IRI_REGISTRY), otherwise owlready2 tries to fetch it live and gets
    # a 403 from cidoc-crm.org.
